...
Update the same way you installed. `p2pmux --version` prints what you are running. A session already running keeps the binary it started with. To pick up a new version, `p2pmux kill <name>` and start again.
