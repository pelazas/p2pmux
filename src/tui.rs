...
use render::agents::{AGENT_OVERLAY_CARD_LINES, agents_overlay_content, render_agents_overlay};
use render::footer::render_contextual_footer;
use render::modals::{render_delete_tab_confirmation, render_rename_prompt, render_share_modal};
use render::vt::{
...
use text::{
    copied_line_count, sanitize_single_line, text_width, truncate_bytes, truncate_trailing,
};
...
mod tests {
    ...
    use super::{
        AGENT_TOGGLE_WINDOW, CHORD_IDLE_TIMEOUT, ChordMode, HostControlEvent, HostPaneChannels,
        HostPaneRuntime, KeyHandling, LayoutControlEvent, MultiPaneTui, PaneMouseProtocol,
        PaneTextSelection, PaneViewState, PendingEscape, RemoteInput, RemoteSubscriptionState,
        ScreenCell, ShareCopy, ShareView, SharedLayoutRuntime, SharedLocalPane, UiIntent,
        grid_for_pane, initial_root_pane_grid, is_chord_command, is_chord_navigation,
        lease_allows_held_input, member_label, pane_border_color, pane_title, pane_wire_id,
        reconcile_remote_control_attempt, remote_input_decision, render_multi_pane,
