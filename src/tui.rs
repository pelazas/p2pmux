...
use render::agents::{AGENT_OVERLAY_CARD_LINES, agents_overlay_content};
use render::panes::{
    TAB_BAR_SEPARATOR, TOP_BAR_BRAND, TOP_BAR_BRAND_SEPARATOR, render_shared_multi_pane, tab_label,
};
...
mod tests {
    ...
    use super::{
        ...
        ScreenCell, ShareCopy, SharedLayoutRuntime, SharedLocalPane, UiIntent, grid_for_pane,
        initial_root_pane_grid, is_chord_command, is_chord_navigation, lease_allows_held_input,
        member_label, pane_wire_id, reconcile_remote_control_attempt, remote_input_decision,
        render_multi_pane, selection_text, viewed_screen,
    };
